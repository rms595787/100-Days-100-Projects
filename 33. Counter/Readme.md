...
> A simple counter that can increment values and store them.   
> Built as part of my 100 Projects Challenge.

---

## 🎥 Demo Video
🔗 Watch here: [Video](./demo/Project%2033.mov)     
<video src="./demo/Project 33.mov" controls width="800"></video>
...
* Creating a simple JS counter
* Saving value on screen using UI update
* Understanding DOM manipulation fundamentals
